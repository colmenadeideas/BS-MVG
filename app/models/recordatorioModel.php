<?php
	...
	class recordatorioModel extends Model {
		...
		public function getRegistrant($data, $by='id') {	
			...
			return DB::query("SELECT * FROM " . DB_PREFIX . "student_profile", $data);
		}	
			
		/*public function getRegistrations($data, $by='id') {
			return DB::query("SELECT * FROM " . DB_PREFIX . "courses_registrations", $data);
		}*/
