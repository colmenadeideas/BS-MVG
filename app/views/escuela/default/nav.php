		...
		<div class="navbar navbar-default" role="navigation">
			...
			<div class="navbar-collapse collapse sidebar-navbar-collapse">
				<ul class="nav navbar-nav navegacion" id="sidenav01">
					<li class="active">
						<img class="img-responsive" src="<?php echo IMG; ?>mimodelsview-logo.gif">
						
						
					</li>
					<li>
						<a href="#" data-toggle="collapse" data-target="#toggleDemo" data-parent="#sidenav01" class="collapsed"> <span class="glyphicon glyphicon-cog"></span> Mi perfil<span class="caret pull-right"></span> </a>
