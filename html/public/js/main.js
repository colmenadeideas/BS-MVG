require.config({
	...
	shim: {
        ...
        'common': ['jquery','assets/jquery.validate.min','assets/bootstrap-editable.min', 'assets/jquery.easing.min', 
        'assets/jquery-ui.min','assets/bootstrap-datetimepicker','assets/jquery.fullpage.min', 'config'],
        'app/login': ['common'],
