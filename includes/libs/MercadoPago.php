...
class MP {
	...
	public function get_access_token() {
		$app_client_values = $this -> build_query(array('client_id' => $this -> client_id, 'client_secret' => $this -> client_secret, 'grant_type' => 'client_credentials'));
	...
	public function refund_payment($id) {
		...
		$refund_status = array("status" => "refunded");
